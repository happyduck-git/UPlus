...
final public class AnimationView: AnimationViewBase {
  ...
  public func getValue(for keypath: AnimationKeypath, atFrame: AnimationFrameTime?) -> Any? {
    ...
    public func getLayerKeypaths() -> [String] {
        if let animationContainer = animationLayer as? AnimationContainer {
            return animationContainer.getLayerKeypaths()
        }
        return []
    }
...
//      NotificationCenter.default.post(name: IndicatorViewController.notiKey, object: nil)
  }
