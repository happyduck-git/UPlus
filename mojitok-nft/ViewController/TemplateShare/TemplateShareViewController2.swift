...
final class TemplateShareViewController2: UIViewController, View {
    ...
    // MARK: - Init
    init(reactor: TemplateShareViewReactor2) {
    ...
    // MARK: - Setup Method
    func bind(reactor: TemplateShareViewReactor2) {
        setUI()
        bindState(reactor)
        bindAction(reactor)
    }
    ...
    private func bindState(_ reactor: TemplateShareViewReactor2) {
    ...
    private func bindAction(_ reactor: TemplateShareViewReactor2) {
...
extension TemplateShareViewController2: TopBarDelegate {
...
extension TemplateShareViewController2: ExportButtonViewDelegate {
...
extension TemplateShareViewController2: TwitterPreviewViewDelegate {
    func closeButton() {
