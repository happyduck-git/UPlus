...
typealias TemplateSection = SectionModel<Void, TemplateCellReactor>

final class TemplateCreateViewReactor: Reactor, FactoryModule {
    // MARK: - Declarations
    struct Dependency {
        let templateShareViewReactorFactory: TemplateShareViewReactor.Factory
