...
final class TemplateCreateViewController2: UIViewController, View {
    // MARK: - UI Component
    ...
    // MARK: - Init
    init(reactor: TemplateCreateViewReactor2) {
    ...
    // MARK: - Setup Method
    func bind(reactor: TemplateCreateViewReactor2) {
        setUI()
        bindState(reactor)
        bindAction(reactor)
    }
    ...
    private func setUI() {
        ...
        contentView.snp.makeConstraints {
            ...
            $0.top.equalTo(shareButton.snp.bottom).offset(7 * scale)
    ...
    private func bindState(_ reactor: TemplateCreateViewReactor2) {
...
//                self?.pushShareVC()
    ...
    private func bindAction(_ reactor: TemplateCreateViewReactor2) {
    ...
    private func pushShareVC() {
        ...
        DispatchQueue.main.async { [weak self] in
            let vc = TemplateShareViewController2(reactor: reactor.dependency.templateShareViewReactorFactory.create(payload: .init(art: reactor.payload.art!, isLive: true)))
...
extension TemplateCreateViewController2: TopBarDelegate {
